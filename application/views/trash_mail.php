...
<html lang="ja">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">ごみ箱</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body p-0">
                                <div class="mailbox-controls">
                                    ...
                                    <div class="btn-group">
                                        <button type="button" onclick="button_re_mail()" class="btn btn-default btn-sm"><i class="fas fa-recycle"></i></button>
                                    </div>
                                    <!-- /.btn-group -->
                                    <button type="button" class="btn btn-default btn-sm" onclick='location.href = "<?= base_url(); ?>index.php/mail/trash"'><i class="fas fa-sync-alt"></i></button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php }; ?> 
                                                    ...
                                                    ?>
                                                        <?= form_open("mail/re_box",$set) ?>
                                                            <input type="hidden" name="re_mail" value="<?= $mail_key ?>">
                                                            <button type="button" class="btn btn-block btn-danger btn-sm" 
                                                            onclick="re_mails('<?= $mail_key; ?>')">復活</button>
                                                        </form>
                                                    </td>
                                            </tr>
                                            <?php };
    ...
    <?php
        ...
        function button_re_mail(){
            if ($('input[type="checkbox"]:checked').length > 0) {
                Swal.fire({
                    title: '登録復帰申請',
                        text: "選択されたメルマガを復帰しますか？",
                        icon: 'question',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
                    ...
                    if (result.value) {
                        ...
                        var hostUrl= '<?= base_url(); ?>index.php/mail/some_return';
                            $.ajax({
                                url: hostUrl, // URLを指定
                                ...
                                data: { // データを指定
                                    ...
                                    if(data == "success"){
                                        location.href = "<?= base_url(); ?>index.php/mail/trash?flag=1";
                                    }else{
                                        location.href = "<?= base_url(); ?>index.php/mail/trash?flag=2";
                                    }
                            }).fail(function(data) {
                                // 通信失敗時の処理
                                location.href = "<?= base_url(); ?>index.php/mail/trash?flag=2";
