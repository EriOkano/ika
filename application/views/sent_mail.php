                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body p-0">
                            <div class="mailbox-controls">
                                ...
                                <div class="btn-group">
                                    <button type="button" onclick="deletes()" class="btn btn-default btn-sm"><i class="far fa-trash-alt"></i></button>
                                </div>
                                <!-- /.btn-group -->
                                    <button type="button" class="btn btn-default btn-sm" onclick='location.href = "<?= base_url(); ?>index.php/mail/sent_mail"'><i class="fas fa-sync-alt"></i></button>
