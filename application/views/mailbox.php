                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body p-0">
                                <div class="mailbox-controls">
                                    ...
                                    <!-- /.btn-group -->
                                        <button type="button" class="btn btn-default btn-sm" onclick='location.href = "<?= base_url(); ?>index.php/mail/mailbox"'><i class="fas fa-sync-alt"></i></button>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="mailbox-subject"><b><?= $datas[$i]["mail_subject"] ?></b></td>
                                                        <td class="mailbox-sending"><b><?= $datas[$i]["flag"] ?></b></td>
                                                        <td class="mailbox-date"><?= $datas[$i]["send_date"] ?></td>
