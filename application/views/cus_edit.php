            ...
            <div class="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        ...
                        <li class="breadcrumb-item active">顧客情報編集</li>
                        </ol>
                    </div>
                    </div>
                </div><!-- /.container-fluid -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">顧客登録情報変更フォーム　：　登録店舗ID　</h3><?=$_SESSION["shop_id"]; ?>
                            </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <!-- <form role="form" id="quickForm"> -->
                                    <?php $set = array(
                                        ...
                                        echo form_open("customer/do_edit",$set)?>
                                            <div class="card-body">
                                            <div class="form-group">
                                                <label>氏名</label>
                                                <input type="text" name="cus_name" class="form-control" value="<?= $cus_datas["cus_name"]?>" placeholder="（例）田中　太郎">
                                            </div>
                                            <div class="form-group">
                                                <label>フリガナ</label>
                                                <input type="text" name="cus_kana" class="form-control" value="<?= $cus_datas["cus_kana"]?>" placeholder="（例）タナカ　タロウ">
                                            </div>
                                            <div class="form-group">
                                                <label>性　別</label>
                                                <?php if($cus_datas["cus_gender"] == "0"){ ?>
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input" type="radio" id="customRadio1" name="cus_gender" value=0 checked="">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <?php }else{ ?> 
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio" id="customRadio1" name="cus_gender" value=0 >
                                                    <label for="customRadio1" class="custom-control-label">男性</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio" id="customRadio2" name="cus_gender" value=1 checked="">
                                                    <label for="customRadio2" class="custom-control-label">女性</label>
                                                </div>
                                                    <?php }; ?>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="<?= $cus_datas["cus_birth"]?>" class="form-control" name="cus_birth"
                                            ...
                                            <div class="form-group">
                                                <label>電話番号</label>
                                                <input type="tel" name="cus_tel" class="form-control" value="<?= $cus_datas["cus_tel"]?>" placeholder="（例）01234567890　　数字のみ">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Email アドレス</label>
                                                <input type="email" name="cus_mail" class="form-control" value="<?= $cus_datas["cus_mail"]?>" id="exampleInputEmail1" placeholder="（例）sample@sample.com">
                                            </div>
                                            <div class="form-group mb-0">
                                                <div class="custom-control custom-checkbox">
                                                    <?php if($cus_datas["cus_magazine"] == "1"){ ?>
                                                        <input type="checkbox" name="cus_maga" value=1 class="custom-control-input" id="exampleCheck2" checked="checked">
                                                    <?php }else{ ?> 
                                                        <input type="checkbox" name="cus_maga" value=1 class="custom-control-input" id="exampleCheck2">
                                                    <?php }; ?>
                                            ...
                                            <input type="hidden" name="edit_key" value="<?= $cus_datas["cus_id"]?>">
                                        </div>
                                        <!-- /.card-body -->
                                        <div class="card-footer">
                                        <b>登録名：<?= $cus_datas["cus_name"]?>　の情報を　
                                        <button type="submit" name = "cus_edit" class="btn btn-primary">編集</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
