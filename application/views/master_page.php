                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="">管理者ページ</a></li>
                    ...
                    <div class="col-sm-12">
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                <h3 class="card-title">店舗情報一覧</h3>
                                    <div class="float-sm-right">
                                        <div class="btn-group">
                                            <button type="button" class="btn bg-gradient-danger" 
                                            onclick="location.href='<?=base_url(); ?>index.php/shop/del_page'">削除店舗一覧</button>
                                            <button type="button" class="btn bg-gradient-info" 
                                            onclick="location.href='<?=base_url(); ?>index.php/log/regis'">新規店舗登録</button>
                                            <button type="button" class="btn bg-gradient-secondary" onclick="location.href='<?=base_url();?>index.php/shop/csv'">download</button>
                                        </div>
                                    </div>
                            </div>
                            <!-- /.card-header -->
                                                ...
                                                foreach($all_data as $data){ ?>
                                                    ...
                                                    <?php foreach($data as $shop_key => $shop_data){ 
                                                        ...
                                                        <?php $set = array('id' => $shop_id);?>
                                                            <?= form_open("shop/del_shops",$set) ?>
                                                                <input type="hidden" name="delete" value="<?= $shop_id; ?>">
                                                                <button type="button" class="btn btn-block btn-danger btn-sm" 
                                                                id="delete" onclick="deletes('<?= $shop_id; ?>')">削除</button>
                                                            </form>
                                                        </td>
                                                        </tr>
                                                <?php } ?>
