                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                ...
                                <li class="breadcrumb-item active">メルマガ新規登録</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <?= form_open("mail/reservation",$set); ?>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label>本　文</label>
                                        <textarea id="compose-textarea" name="text" class="form-control" style="height: 300px" required></textarea>
                                    </div>
                                        <div class="form-group">
                ...
                if(isset($_GET["flag"])){
                    if($_GET["flag"] == 2){ ?>
                        $(document).Toasts('create', {
                            class: 'bg-danger', 
                            title: 'エラー',
                            body: 'メルマガ登録に失敗しました。<br>再度時間をおいて実行してください。'
                        });
                <?php }; ?>
            <?php }; ?>
